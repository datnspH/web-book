    ...
    return (
        <div>
            <form className="flex items-center mr-auto " onSubmit={handleSubmit(onHandlesSearch)}>
                ...
                <input
                    className="block w-full h-10 px-5 py-2 outline-none hover:border-red-300 border hover:border duration-200 rounded-s-lg"
                    type="text"
                ...
                <button id="clickShowProduct"
                    type="submit"
                    className="px-8 py-2 d-r-lg bg-red-300"
                    aria-label="Justify"
